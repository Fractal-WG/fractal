...
const file_rpc_proto_rawDesc = "" +
	...
	"\x0eDeleteBuyOffer\x12+.fractalengine.rpc.v1.DeleteBuyOfferRequest\x1a,.fractalengine.rpc.v1.DeleteBuyOfferResponseB.Z,dogecoin.org/fractal-engine/pkg/rpc/protocolb\x06proto3"
